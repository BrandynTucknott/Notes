# ADMM for reduced C-hull classifier
...
initialize:
    ...
    for i < MAX_ITER:
        ...
        x = project_to_capped_simplex(u + lambda_u)
        y = project_to_capped_simplex(v + lambda_v)
...
for i in range(MAX_ITER):
    ...
    x = project_to_capped_simplex(u + lambda_u, d)
    y = project_to_capped_simplex(v + lambda_v, d)
